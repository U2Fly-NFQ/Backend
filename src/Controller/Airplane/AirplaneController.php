...
class AirplaneController extends AbstractController
{
    ...
    #[Route('/api/airplanes/{id}', name: 'app_delete_airplane', methods: 'DELETE')]
    public function delete(Airplane $airplane, AirplaneRepository $airplaneRepository): JsonResponse
    {
