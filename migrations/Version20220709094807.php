...
final class Version20220709094807 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE flight_seat_type DROP FOREIGN KEY FK_39F807A91F478C5');
        ...
        $this->addSql('ALTER TABLE flight_seat_type DROP FOREIGN KEY FK_39F807A4ECEE001');
