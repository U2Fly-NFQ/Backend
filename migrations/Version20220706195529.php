 ...
 */
final class Version20220706195529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE city (id INT AUTO_INCREMENT NOT NULL, avatar_id INT DEFAULT NULL, airport_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, attractive INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, UNIQUE INDEX UNIQ_2D5B023486383B10 (avatar_id), INDEX IDX_2D5B0234289F53C8 (airport_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rating (id INT AUTO_INCREMENT NOT NULL, account_id INT NOT NULL, airline_id INT NOT NULL, rate INT NOT NULL, comment VARCHAR(255) DEFAULT NULL, create_at DATETIME NOT NULL, INDEX IDX_D88926229B6B5FBA (account_id), INDEX IDX_D8892622130D0C16 (airline_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ticket (id INT AUTO_INCREMENT NOT NULL, passenger_id INT NOT NULL, discount_id INT DEFAULT NULL, seat_type_id INT NOT NULL, total_price DOUBLE PRECISION NOT NULL, ticket_owner VARCHAR(100) NOT NULL, payment_id VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, status INT DEFAULT NULL, INDEX IDX_97A0ADA34502E565 (passenger_id), INDEX IDX_97A0ADA34C7C611F (discount_id), INDEX IDX_97A0ADA34ECEE001 (seat_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ticket_flight (id INT AUTO_INCREMENT NOT NULL, flight_id INT NOT NULL, ticket_id INT NOT NULL, rating_id INT DEFAULT NULL, is_rating TINYINT(1) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, deleted_at DATETIME NOT NULL, INDEX IDX_B8158CC591F478C5 (flight_id), INDEX IDX_B8158CC5700047D2 (ticket_id), INDEX IDX_B8158CC5A32EFC6 (rating_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ticket_flight ADD CONSTRAINT FK_B8158CC5A32EFC6 FOREIGN KEY (rating_id) REFERENCES rating (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE city DROP FOREIGN KEY FK_2D5B023486383B10');
        $this->addSql('ALTER TABLE ticket DROP FOREIGN KEY FK_97A0ADA34502E565');
        $this->addSql('ALTER TABLE ticket_flight DROP FOREIGN KEY FK_B8158CC5A32EFC6');
